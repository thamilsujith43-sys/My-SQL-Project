...
GROUP BY — aggregating data for summaries

JOINs — combining tables to enrich analysis
...
Summarise sales by region, category, and time period

Join multiple tables to uncover deeper insights
...
LEFT JOIN to include customers with or without purchases

RIGHT JOIN for supplier‑related analysis
...
Found customer groups with high purchase frequency

Revealed patterns in seasonal or monthly sales
